...
export const createNewService = async (service:newServiceType) => {
        const result = await sql`
        INSERT INTO homeservices (hostname, servicetype, accomodation, placename, placelocation, subdescription, description, services, price, startdate, enddate, coordinate)
        VALUES (${service.hostname}, ${service.serviceType}, ${service.accomodation}, ${service.placename}, ${service.placeLocation}, ${service.subDescription}, ${service.description}, ${service.services}, ${service.price}, ${service.startDate}, ${service.endDate}, ${service.coordinate})
        RETURNING *;
        `;
}
